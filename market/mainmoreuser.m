...
ntl(:,1:10)=ntl
ntl(:,11:usernum)=ntl(:,9).*(0.5+rand(24,usernum-10));
pv(:,1:10)=pv
pv(:,11:usernum)=pv(:,9).*(0.5+rand(24,usernum-10));
ntl_pred(:,1:10)=ntl_pred
ntl_pred(:,11:usernum)=ntl_pred(:,9).*(0.5+rand(24,usernum-10));
pv_real(:,1:10)=pv_real
pv_real(:,11:usernum)=pv_real(:,9).*(0.5+rand(24,usernum-10));
...
for i=2:25
    SOCsd(i)=SOCsd(i-1)+Esd(i-1);%31779-3369 * 0.86-0.37  38000-3400 *1.37-0.35
end
